...
export const PrivacyPage = () => {
    ...
    return (
        <div className={s.inner}>
            ...
            <p className={s.text}>
                1. By using our Website and Application, you confirm that you
            ...
            <p className={s.text}>
                1. We provide you with the Application app that is a self-hosted, non-custodial
            ...
            <p className={s.text}>
                1. To use the Application app, it will be necessary for you to register an
            ...
            <p className={s.text}>
                1. You acknowledge that all the rights in and to the Application and to the Website
                 and any content displayed thereon (including but not limited to
            ...
            <p className={s.text}>
                ...
                app a backup of any wallet address and private key pair that you maintain in
            ...
            <p className={s.text}>
                1. We may suspend your right to use the Website and/or the Application immediately if we determine that your use of the Application violated
            ...
            <p className={s.text}>
                ...
                and/or Application , until the date of termination in accordance
                with this Clause 7.
            </p>
            ...
            <p className={s.text}>1. your use of, or inability to use the app</p>
            ...
            <p className={s.text}>
                1. THE WEBSITE AND/OR APPLICATION ARE PROVIDED "AS IS". EXCEPT TO
            ...
            <p className={s.text}>
                ...
                Application(app); or (iv) any bugs, viruses, trojan horses, or the like that
                are found in the Application(app) or that may be transmitted to or through our
